...
export const UsuariosPage: React.FC = () => {
  ...
  // Estados para controlar los índices sobre los que se hace Hover dinámico
  ...
  if (cargando) return <div style={styles.centro}>Cargando panel de biblioteca...</div>;
          ...
          <div style={styles.cardTablaCristal}>
            <div style={styles.encabezado}>
              <div>
                ...
                <p style={styles.subtituloSeccion}>Listado oficial de miembros con acceso a préstamos de ejemplares.</p>
              </div>
              <button 
                style={{
                  ...styles.botonNuevo,
            ...
            {usuarios.length === 0 ? (
              <p style={styles.vacioText}>No hay lectores registrados en el sistema de biblioteca.</p>
            ) : (
                ...
                <table style={styles.tabla}>
                  ...
                  <tbody>
                    {usuarios.map((usuario, index) => (
                      ...
                      >
                        <td style={styles.tdId}>{usuario.id}</td>
                        ...
                        <td style={styles.td}>
                          ...
                          <button style={styles.botonEliminar}>🗑️ Dar de baja</button>
                        </td>
                      </tr>
                    ))}
                  </tbody>
...
// Estructura de Estilos Limpia y Centralizada fuera de la maquetación
const styles = {
  contenedorConFondo: {
  ...
  botonEditar: { backgroundColor: '#fef3c7', color: '#d97706', border: 'none', padding: '6px 14px', marginRight: '8px', borderRadius: '6px', cursor: 'pointer', fontWeight: '600', fontSize: '13px', transition: 'background-color 0.2s' },
  botonEliminar: { backgroundColor: '#fee2e2', color: '#dc2626', border: 'none', padding: '6px 14px', borderRadius: '6px', cursor: 'pointer', fontWeight: '600', fontSize: '13px', transition: 'background-color 0.2s' },
  vacioText: { padding: '40px', textAlign: 'center' as const, color: '#64748b', fontSize: '15px' },
  centro: { display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', fontSize: '16px', fontWeight: '600', color: '#ffffff', backgroundColor: '#0f172a', fontFamily: 'system-ui' }
};
